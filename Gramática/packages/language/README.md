...
- [src/pop.langium](src/pop.langium) -  The grammar definition of your language
- [src/pop-module.ts](src/pop-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/pop-validator.ts](src/pop-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/pop.monarch.ts](src/syntaxes/pop.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/pop.tmLanguage.json](syntaxes/pop.tmLanguage.json) - Textmate based syntax highlighting instructions.
